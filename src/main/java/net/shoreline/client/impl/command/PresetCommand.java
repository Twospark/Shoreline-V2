...
import net.shoreline.client.api.preset.SettingPreset;
...
public class PresetCommand extends Command
{
            ...
            throws IOException
    {
        ...
        {
            return new SettingPreset<>(name, Managers.MODULES.getRegistry().getCollection());
        }
        else if (string.equalsIgnoreCase("renders"))
        {
            return new SettingPreset<>(name, Managers.MODULES.getModules(
                    module ->  module.getCategory() == Category.RENDER));
        }
        else if (string.equalsIgnoreCase("combat"))
        {
            return new SettingPreset<>(name, Managers.MODULES.getModules(
                    module -> module.getCategory() != Category.RENDER && !(module instanceof ThemeModule)));
        }
