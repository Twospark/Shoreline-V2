...
public class AbstractSocialCommand extends Command
{
    ...
    public AbstractSocialCommand(SocialType socialType)
    {
            ...
            .then(buildArgument("player name", PlayerArgumentType.player())
                .executes(context ->
                {
                    ...
                    if (action.equalsIgnoreCase("add"))
                    {
                        ...
                        sendClientChatMessage(format("Added <type> with name " + ChatFormatting.GOLD + playerName));
                    ...
                    else if (action.equalsIgnoreCase("del") || action.equalsIgnoreCase("delete") || action.equalsIgnoreCase("remove"))
                    {
                        ...
                        sendClientChatMessage(format("Removed <type> with name " + ChatFormatting.RED + playerName));
                ...
                .executes(context ->
                {
                    ...
                    if (action.equalsIgnoreCase("list"))
                    {
                        ...
                        sendClientChatMessage(format(ChatFormatting.GRAY + "<type>s: " + ChatFormatting.WHITE + String.join(", ", playerNames)));
                        return 1;
                    }
