...
@Setter
public class ShaderNodeCollector extends SubmitNodeStorage
{
                                ...
                                ModelFeatureRenderer.CrumblingOverlay crumblingOverlay)
    {
        ...
        consumer = sprite != null ? sprite.wrap(consumer) : consumer;
        try
        {
                                ...
                                int outlineColor)
    {
        ...
        try
        {
            modelPart.render(poseStack, consumer, lightCoords, overlayCoords, tintedColor);
        }
        catch (Exception ignored)
        {
        }
